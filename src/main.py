...
# Add the project root to the sys.path to ensure all imports work correctly
...
def import_module_from_path(module_name, file_path):
    ...
    # Add the module to sys.modules to ensure it's properly registered
...
def run_scraping_pipeline(source, max_pages=None):
    ...
    # Set environment variable for max_pages if provided
    ...
    if source == "all":
        ...
        for src in available_sources:
            ...
            if os.path.exists(pipeline_path):
                ...
                # Use the full module name to ensure proper registration
...
def main():
    ...
    parser.add_argument('--pipeline', type=str, choices=['scraping', 'clustering'], required=True,
