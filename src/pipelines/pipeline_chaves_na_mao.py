...
# Load configuration for chaves_na_mao
    ...
    while True:
        ...
        if response.status_code == 200:
            ...
            for i, card_imovel in enumerate(cards_imoveis):
                ...
                tamanho = chavesNaMao.return_chaves_na_mao_tamanho(
                    card_imovel,
                ...
                n_quartos = chavesNaMao.return_chaves_na_mao_n_quartos(
                    card_imovel,
                ...
                n_banheiros = chavesNaMao.return_chaves_na_mao_n_banheiros(
                    card_imovel,
                ...
                n_garagem = chavesNaMao.return_chaves_na_mao_n_vagas_garagem(
                    card_imovel,
                ...
                rua, bairro, cidade = chavesNaMao.return_chaves_na_mao_endereco(
                    card_imovel,
...
# Fazer função para registro de fatos de preço dos imóveis
